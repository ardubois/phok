...
gpu_resp = d_buf
  |> map_step_2_para_no_resp_kernel(size_body,d_buf,nBodies,nBodies, &NBodies.gpu_nBodies/3)
  |> map_step_2_para_no_resp_kernel(size_body, 0.01,nBodies,nBodies, &NBodies.gpu_nBodies/3)
  |> Hok.get_gnx
  |> IO.inspect
